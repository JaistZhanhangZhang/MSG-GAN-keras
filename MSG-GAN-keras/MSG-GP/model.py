...
model=Conv2D(16,(3,3),padding='same')(inp_1024)
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)

# D Block 1
model=MinibatchStddev()(model) #                                MiniBatchStd 
model=Conv2D(16,(3,3),padding='same')(model)#                   Conv
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
model=Conv2D(32,(3,3),padding='same')(model)#                  Conv
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
...
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
model=Conv2D(64,(3,3),padding='same')(model)#                  Conv
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
model=AveragePooling2D()(model)#                                AveragePooling
...
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
model=Conv2D(128,(3,3),padding='same')(model)#                  Conv
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
model=AveragePooling2D()(model)#                                AveragePooling
...
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
model=Conv2D(256,(3,3),padding='same')(model)#                  Conv
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
model=AveragePooling2D()(model)#                                AveragePooling
...
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
model=Conv2D(512,(3,3),padding='same')(model)#                  Conv
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
model=AveragePooling2D()(model)#                                AveragePooling
...
model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
model=Conv2D(512,(4,4),padding='same')(model)#                  Conv
#model=PixelNorm()(model)
model=LeakyReLU(0.2)(model)
